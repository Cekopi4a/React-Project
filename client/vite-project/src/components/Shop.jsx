...
<div className="container px-4 px-lg-5 mt-5">
             ...
             <button type="button" class="btn btn-primary"><i class="bi bi-cart-fill"></i></button>
                            </div>
                         </div>
                        </div>
                    </div>
  ...
  <button type="button" class="btn btn-outline-primary"><i class="bi bi-eye-fill"></i></button>
